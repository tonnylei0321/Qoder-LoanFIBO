...
Stubs out heavy external dependencies (LangChain, SQLAlchemy, rdflib, etc.)
...
# TTL indexer — mocked for other tests; test_ttl_indexer.py pops this to import the real module
_ttl_mock = MagicMock()
